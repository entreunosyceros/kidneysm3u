...
2. **[Uso](uso.md)** — Primeros pasos: arrancar, cargar una lista, reproductor, preferencias, **YouTube**, **Twitch**, **Kick**, biblioteca unificada y **Ayuda → Buscar actualizaciones**.
...
5. **[Reproductor](reproductor.md)** — Controles, grabación, PiP, atajos, favoritos, biblioteca, lista lateral, guía EPG, pantalla completa y bandeja del sistema.
6. **[Notas](notas.md)** — Cómo reproduce VLC/yt-dlp, buffer IPTV, archivos de configuración (incl. cookies Twitch/Kick), tests, monitor de CPU, actualizaciones y fallos conocidos.

## Convención de enlaces

- **Inicio** siempre apunta a `README.md` en la raíz del proyecto.
- **Índice** es esta página.
- El resto de enlaces de la barra son las páginas de esta carpeta.
