...
- Abajo: **Sesión YouTube: OK / caducada** y **Reexportar cookies** (también en el menú **Youtube**). Si YouTube pide login o un bot-check, el indicador pasa a caducada. En **Windows**, Chrome y Edge casi nunca funcionan para esto: en **Preferencias** deja el navegador de cookies en **Automático** o **Firefox**. Detalle en [YouTube](youtube.md#windows-firefox-no-chrome-ni-edge).
