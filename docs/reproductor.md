...
- Abajo a la izquierda ya no hay indicadores de cookies: están en **Archivo → Preferencias → pestaña Cookies** (YouTube y Twitch, con **Reexportar cookies**). Los menús **Youtube** y **Twitch** siguen mostrando **Sesión …: OK / caducada**. En **Windows** usa Firefox (Chrome, Brave y Edge cifran las cookies). Detalle en [YouTube](youtube.md#cookies).
